    ...
    with left_column:
        ...
        st.write(
            ...
            - I'm currently pursuing my post graduation in data science and machine learning from Manipal Academy Of Higher Education 
              and have a keen interest in Data Vizualisation,Statistical analysis and Machine learning algorithms, topics on which I'm currently working on to bring professional competency. 
            
            - I also hold a Bachelor's degree in Mechanical Engineering from Visvesvaraya Technological University with a first clss with distinction.
            ...
            - I also have knowledge on Deep Learning Algorithms and Image Classification using CNN architecture and Image augmentation techniques.
